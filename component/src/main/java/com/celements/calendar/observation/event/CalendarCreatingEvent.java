...
public class CalendarCreatingEvent extends AbstractDocumentEvent {
   ...
   */
  public CalendarCreatingEvent(DocumentReference documentReference) {
   ...
   */
  public CalendarCreatingEvent(EventFilter eventFilter) {
    super(eventFilter);
  }
}
