...
public class CalendarDeletingEvent extends AbstractDocumentEvent {
   ...
   */
  public CalendarDeletingEvent(DocumentReference documentReference) {
   ...
   */
  public CalendarDeletingEvent(EventFilter eventFilter) {
    super(eventFilter);
  }
}
