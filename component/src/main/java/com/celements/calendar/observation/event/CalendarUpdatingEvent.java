...
public class CalendarUpdatingEvent extends AbstractDocumentEvent {
   ...
   */
  public CalendarUpdatingEvent(DocumentReference documentReference) {
   ...
   */
  public CalendarUpdatingEvent(EventFilter eventFilter) {
    super(eventFilter);
  }
}
